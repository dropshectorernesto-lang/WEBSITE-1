...
Every demo wrapper loads the shared `demo-global.js`, so language-sensitive demo fixes (including Blog preview localization) automatically carry forward to future customer demos that use the same wrapper template.
